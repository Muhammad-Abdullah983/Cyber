...
import { IoChevronForward, IoHeartOutline, IoHeart } from "react-icons/io5";
  ...
  return (
    ...
    <div className="w-full pb-20"> 
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <button className="flex-1 py-4 rounded-lg bg-black text-white font-semibold hover:bg-gray-800 transition cursor-pointer  shadow-lg">
                Add to Cart
              </button>
            </div>
      ...
      <div className="max-w-[80%] mx-auto px-4 md:px-0 mt-16 mb-20">
        ...
        <textarea 
            className="w-full h-12 p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black text-sm text-gray-800 resize-none"
            placeholder="Leave Comment"
            aria-label="Leave your review comment here"
        ></textarea>
