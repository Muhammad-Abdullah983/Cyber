...
export default function HeroSection() {
    return (
        <section className="w-full flex flex-col md:flex-row items-center justify-between px-6 md:px-16 lg:px-24 gap-12 bg-[var(--darkblack)]">
            ...
            {/* Left side - text */}
            <div className="flex-1 text-center md:text-left  w-[100%] md:ml-11  mt-22 md:mt-0">
                <h1 className="font-semibold text-[20px] md:text-[25px] text-white pb-3 opacity-40">
                    Pro.Beyond.
                </h1>
                <p className="text-7xl font-thin sm:text-6xl md:text-7xl lg:text-8xl text-white tracking-[-1px] pb-4  leading-tight">
            ...
            {/* Right side - image */}
            {/* Right side - image */}
            <div className="sm:mr-10 flex justify-center  md:justify-end">
                ...
                <Image
                    ...
                    width={343}
                    height={289}
                    className="object-contain  object-bottom block h-[289px] w-[343px] sm:hidden" // visible only on mobile (<640px)
                />
